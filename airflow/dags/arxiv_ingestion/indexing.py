...
# Heavy service imports are deferred to inside functions — do NOT move to module
# level. Airflow parses this file on every heartbeat; top-level torch/docling
# imports cause the 30-second DAG import timeout.
